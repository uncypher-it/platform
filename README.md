...
| Claude/codebase agent 401 | OAuth chain expired. Set `ANTHROPIC_API_KEY`, or run `claude login` on the host and enable `claude-auth-refresh.service` — see [`claude-auth/README.md`](claude-auth/README.md) |
